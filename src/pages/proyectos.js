...
const ProjectsPageEs = () => (
    <Layout to_en_es="/projects/">
        ...
        <Project linkto="https://github.com/miguelgondu/minimal_VAE_on_selfies" title="Una implementación mínima de VAEs para moléculas" imgsrc="/assets/example_molecule.png">Un Autocodificador Variacional (Variational Autoencoder en inglés) que genera moléculas pequeñas usando la representación SELFIES.</Project>

        <Project linkto="https://github.com/miguelgondu/minimal_VAE_on_Mario" title="Una implementación mínima de VAEs para niveles de Super Mario Bros" imgsrc="/assets/mario_blogpost/1982.png">Un Autocodificador Variacional que genera niveles de Super Mario Bros. El proyecto incluye un simulador que te permite jugar los niveles directo desde el espacio latente.</Project>
