...
export default () => (
    <Layout to_en_es="/projects/">
        ...
        <ul>
            ...
            <li>Implementé un <a href="https://github.com/miguelgondu/voronoi_me" target="_blank" rel="noopener noreferrer">script en Python</a> que transforma fotos usando NumPy, SciPy y PIL. El resultado es una versión low-poly de la foto usando teselaciones de Voronoi.</li>
        </ul>
    </Layout>
)
