...
If this small introduction falls short, I can definitely recommend [this post]() on distill.pub. It introduces the Gaussian as well as Gaussian Process Regression using more interactive charts.
...
[^and-this-I-owe-to-Santiago]: I took this idea from a good friend's blog: [homotopico.com](). Santiago is the best lad.
