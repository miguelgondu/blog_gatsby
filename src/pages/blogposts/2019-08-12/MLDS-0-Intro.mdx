---
date: "2019-08-12"
title: "MLDS 0: Installing and Using Anaconda and Jupyter Notebook"
...
# MLDS 0: Installing and Using Anaconda and Jupyter Notebook

This is the zero-th post on a series about Data Science called 'Miguel Learns Data Science', or MLDS for short. In each post, I plan to introduce a concept, give some mathematical background and give actual examples with code written in Python, using the SciPy suite.
...
For this introduction, I will explain how to set-up your computer for experiments in Python using the Anaconda distribution. I will show how to install it and use Jupyter Notebook, a tool for writing share-able code.
...
In this post I introduced 'Miguel Learn Data Science', a series of posts about concepts in Data Science. In order to follow these posts, it is worthwile to install Anaconda, a Python distribution that comes with all the relevant libraries and tools for daily work in Data Science. This post also shows how to install Anaconda and also contains a small introduction to Jupyter Notebook, which allows us to write explained code and easily share it.