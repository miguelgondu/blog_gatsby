...
date: "2018-09-03"
summary: "sc2reader is a great open source tool to parse SC2Replay files. This is a small tutorial on installing it and using it to scrap basic information from these files."
lang: "en"
categories:
    - Python
    - Video Games
